...
export const metadata: Metadata = {
  title:
    "PickupCraft — A real voice that picks up while you're cutting hair, fixing a sink, or seeing a patient",
  description:
    "PickupCraft runs the front-of-house phone for dentists, plumbers, salons, restaurants, clinics, and contractors. We pick up. We book. We answer. You stay focused on the customer in front of you.",
  metadataBase: new URL("https://voice-agents-local.prin7r.com"),
  openGraph: {
    title: "PickupCraft — Your voice while you're cutting hair",
    description:
