# `apps/app/` — PickupCraft SaaS surface (deferred)

This folder is intentionally empty for Wave 2.

## What lives here eventually

A fork of [`wasp-lang/open-saas`](https://github.com/wasp-lang/open-saas) tuned to PickupCraft's product:
...
│   │   │   └── BillingPage.tsx
│   │   └── components/      # ShadCN re-themed to PickupCraft tokens (DESIGN.md §4–6)
│   ├── server/
│   │   ├── webhooks/
...
to the PickupCraft tokens in the root `DESIGN.md`. No paid component
